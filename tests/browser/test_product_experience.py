...
def test_m66_static_assets_advance_and_retire_previous_shell_cache(tmp_path: Path) -> None:
    with client_for(tmp_path) as client:
        ...
        assert "/static/app.css?v=m66-a-owner-fidelity-v2" in page.text
        assert "/static/pwa.js?v=m66-a-owner-fidelity-v2" in page.text
        assert "/static/species-directory.js?v=m66-a-owner-fidelity-v2" in page.text
        assert 'const ASSET_VERSION = "m66-a-owner-fidelity-v2"' in worker.text
        ...
        assert "/service-worker.js?v=m66-a-owner-fidelity-v2" in pwa.text
