# M6 Accessibility Qualification

Result: **Pass**.

Pa11y 9.0.1 with the Axe runner and WCAG2AA standard reported zero issues on login, Today, reports,
search, and analytics at a 390 by 844 viewport. Empty measurement/feeding tables include explicit
